// this file content has to be copied in from common.js EXCEPT the last line...stupid unpatchable export token breakign every content script....
...
// END above is literally copied and pasted in here, for sharing 3 functions common code with bg page

// hey, someday we can detect export is not supported and have this code NOT make the whole script in flight crash our right here...
// what a nonsense piece of undetectable folly the export statement seems to be? who decided though shalt not monkey patch the stupid hting into some sort of working(ignored) state at least.... when not in a module.... so why would someoen want to use another program to bundle the output?  I want less programs not more.
...
//export { loadPrefs:loadPrefs, goToOrOpenOptions:goToOrOpenOptions, processFileRows:processFileRows } // HAH even this doesnt' work... NOOBS
